...
```bash
wget https://go.dev/dl/go1.23.0.darwin-arm64.tar.gz
sudo rm -rf /usr/local/go && sudo tar -C /usr/local -xzf go1.23.0.darwin-arm64.tar.gz
```
